...
public class formegzersiz extends AppCompatActivity {
    static List<FlagType> dataList;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_formegzersiz);

        getSupportActionBar().setTitle("FORMA GİRME EGZERSİZLERİ");
...
/*                Intent intent = new Intent(getApplicationContext(),bacakegzersizlerdetail.class);
    ...
    public boolean onOptionsItemSelected(@NonNull @NotNull MenuItem item) {
        ...
        if (id == android.R.id.home) {
            Intent categoryIntent = new Intent(formegzersiz.this, bolgeler.class);
